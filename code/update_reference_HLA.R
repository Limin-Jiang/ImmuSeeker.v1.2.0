...
if (file.exists(destfile)){
  print("The HLA sequence data has been successfully downloaded. or")
  print(paste0(destfile, " can be detetced"))
  ...
  cat(d1, file = paste0("data/hla_nuc.fasta"), sep = "\n")
  ...
  print("The HLA sequence data cannot be downloaded at this time. OR")
  print(paste0(destfile, " cannot be detetced"))

...
if (file.exists(file_path)){
  ...
  print(paste0(file_path, " can be detetced"))
  ...
  cat(d1, file = paste0("data/kir_nuc.fasta"), append = FALSE,sep = "\n") 
  ...
  print("The KIR sequence data cannot be downloaded at this time. or")
  print(paste0(file_path, " cannot be detetced"))
